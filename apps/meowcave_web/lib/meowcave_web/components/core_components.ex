defmodule MeowCaveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MeowCaveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MeowCaveWeb.Gettext, "errors", msg, opts)
    end
  end
